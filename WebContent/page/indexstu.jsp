				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li>
							...
							<ul>
								<iframe src="Linkbijistu.html" width="210" height="90" frameborder="no"
						...
						<li>
							<a class="waves-effect waves-dark" href="" aria-expanded="false">
								...
								<span class="hide-menu">在线考试</span>
							</a>
							<ul>
								<iframe src="linkkaoshi.html" width="210" height="60" frameborder="no"
									style="display: block"></iframe>
							</ul>
						</li>
					</ul>
...
<script>
	$(function () {
		($('.sidebar-nav>ul>li').children('ul').children('iframe').hide())
	});
	$(function () {
		$('.sidebar-nav>ul>li').click(
			function () {
				$(this).children('ul').children('iframe').show().parent()
					.parent().siblings('li').children('ul').children(
						'iframe').hide();
			})
	});
</script>
